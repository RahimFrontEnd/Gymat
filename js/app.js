    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".offer__slider")) new core(".offer__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".offer__arrow_left",
                    nextEl: ".offer__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
        ...
        parallax_Parallax.Each = class {
            ...
            parameters(el, parameters) {
                if ("v" == parameters.axis) el.style.transform = `translate3D(0, ${(parameters.direction * (this.value / parameters.coefficient)).toFixed(2)}px,0) ${parameters.additionalProperties}`; else if ("h" == parameters.axis) {
                    ...
                    el.style.opacity = `translate3D(${(parameters.direction * (this.value / parameters.coefficient)).toFixed(2)}px,0,0) ${parameters.additionalProperties}`;
                }
            }
        };
        ...
        function digitsCounter() {
            ...
            function digitsCountersAnimate(digitsCounter) {
                ...
                const step = timestamp => {
                    ...
                    console.log(digitsCounter.innerHTML);
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (searchIcon) document.addEventListener("click", (function(event) {
                if (event.target.closest(".search-header__icon")) document.documentElement.classList.toggle("search-open"); else if (!searchForm.contains(event.target)) document.documentElement.classList.remove("search-open");
            }));
        }));
        window["FLS"] = true;
        isWebp();
